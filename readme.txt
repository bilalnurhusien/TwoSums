...
Design and Analysis course taught by Tim Roughgarden on Coursera.
...
in standard output such that there are distinct numbers x,y in the input file that 
satisfy x+y=t. For the input file, HashInt.txt, the number of target values is 1477.
